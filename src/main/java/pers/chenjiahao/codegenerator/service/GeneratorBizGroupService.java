...
@Slf4j
@Service
public class GeneratorBizGroupService {
    ...
    private static final String resourcePath = "templatesBizGroupRewritedVm/";
...
//        templateConfig.setServiceImpl(resourcePath + "serviceImplWithGroup.java");
        templateConfig.setServiceImpl(resourcePath + "serviceImplSys.java");
